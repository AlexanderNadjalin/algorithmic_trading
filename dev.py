...
def dev():
    ...
    t2 = Transaction(name='AMZ', direction='B', quantity=15.0, price=250.0, commission_scheme='', date='2021-07-07')
    t3 = Transaction(name='AMZ', direction='B', quantity=10.0, price=300.0, commission_scheme='', date='2021-07-07')
    t4 = Transaction(name='AMZ', direction='B', quantity=10.0, price=400.0, commission_scheme='', date='2021-07-07')
